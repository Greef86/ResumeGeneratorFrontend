...
const Languages = () => {
  ...
  return (
    <div>
        ...
        <input value={skill} onChange={event => setSkill(event.target.value)} style={{marginBottom: "0.3em"}} required pattern='^\S+(?: \S+)*$' title='Please enter text without leading or trailing spaces' type="text" placeholder="Language"/>
